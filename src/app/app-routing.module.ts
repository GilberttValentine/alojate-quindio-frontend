...
const routes: Routes = [
  ...
  { path: 'host/lodgings', component: HostLodgingsComponent, data: { title: "Alojamientos - Alójate Quindío" } },
  { path: 'host/lodgings/:lodging_id/reservations', component: LodgingReservationsComponent, data: { title: "Reservaciones - Alójate Quindío" } },
  ...
  { path: 'host/reservations/:id_reservation', component: ViewReservationComponent, data: { title: "Reservacion - Alójate Quindío", host:true} },
