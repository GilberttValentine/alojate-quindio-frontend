...
const routes: Routes = [
  ...
  { path: 'hosts/lodgings', component: HostLodgingsComponent, data: { title: "Alojamientos - Alójate Quindío" } },
  { path: 'hosts/lodgings/:lodging_id/reservations', component: LodgingReservationsComponent, data: { title: "Reservaciones - Alójate Quindío" } },
